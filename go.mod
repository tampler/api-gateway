module github.com/neurodyne-web-services/api-gateway
...
require (
	...
	github.com/neurodyne-web-services/nws-sdk-go v0.0.0-20220517200235-d0b8897e7ee5
...
require (
	github.com/apache/cloudstack-go/v2 v2.13.1 // indirect
